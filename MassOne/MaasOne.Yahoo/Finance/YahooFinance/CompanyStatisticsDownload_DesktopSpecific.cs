...
namespace MaasOne.Finance.YahooFinance
{
    public partial class CompanyStatisticsDownload 
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public async Task<Base.Response<CompanyStatisticsResult>> Download(IID managedID)
        {
            if (managedID == null)
                throw new ArgumentNullException("managedID", "The passed ID is null.");
            return await this.Download(managedID.ID);
        }
        /// <summary>
        /// Downloads company statistic data.
        /// </summary>
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public async Task<Base.Response<CompanyStatisticsResult>> Download(string unmanagedID)
        {
