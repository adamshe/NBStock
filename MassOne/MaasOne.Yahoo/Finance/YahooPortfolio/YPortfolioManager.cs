...
namespace MaasOne.Finance.YahooPortfolio
{
    public partial class YPortfolioManager : YAccountManager
    {
        ...
        private void CreatePortfolio_DownloadCompleted(WebFormUpload sender, DefaultDownloadCompletedEventArgs<XParseDocument> e)
        {
        ...
        private void EditPortfolio_DownloadCompleted(WebFormUpload sender, DefaultDownloadCompletedEventArgs<XParseDocument> e)
        {
        ...
        private void EditPortfolioView_DownloadCompleted(WebFormUpload sender, DefaultDownloadCompletedEventArgs<XParseDocument> e)
        {
        ...
        private void AddPortfolioItem_Completed(DownloadClient<XParseDocument> sender, DownloadCompletedEventArgs<XParseDocument> e)
        {
            ...
            Portfolio pf = new PortfolioDownload().ConvertHtmlDoc(e.Response.Result);
            if (this.AsyncAddPortfolioItemCompleted != null) this.AsyncAddPortfolioItemCompleted(this, ((DefaultDownloadCompletedEventArgs<XParseDocument>)e).CreateNew(pf));
        }
        ...
        private void EditHoldings_DownloadCompleted(WebFormUpload sender, DefaultDownloadCompletedEventArgs<XParseDocument> e)
        {
            ...
            if (this.AsyncEditHoldingsCompleted != null) AsyncEditHoldingsCompleted(this, ((DefaultDownloadCompletedEventArgs<XParseDocument>)e).CreateNew(new PortfolioDownload().ConvertHtmlDoc(e.Response.Result), args.UserArgs));
        }
