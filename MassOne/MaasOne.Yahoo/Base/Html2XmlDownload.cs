...
{
    internal partial class Html2XmlDownload : DownloadClient<XParseDocument>
    {
        ...
        protected override XParseDocument ConvertResult(ConnectionInfo connInfo, System.IO.Stream stream, SettingsBase settings)
        {
