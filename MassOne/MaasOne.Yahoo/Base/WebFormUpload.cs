...
namespace MaasOne.Base
{
    internal partial class WebFormUpload
    {
        ...
        public delegate void AsyncDownloadCompletedEventHandler(WebFormUpload sender, DefaultDownloadCompletedEventArgs<XParseDocument> e);
        ...
        private void html_DownloadAsyncCompleted(DownloadClient<XParseDocument> sender, DownloadCompletedEventArgs<XParseDocument> e)
        {
