...
namespace MaasOne.Base
{
    public partial class ConnectionInfo
    {
      ...
      //  public KeyValuePair<HttpResponseHeader, string>[] ResponseHeaders { get { return mResponseHeaders; } }
        public KeyValuePair<string, string>[] ResponseHeaders { get { return mResponseHeaders; } }
        private KeyValuePair<string, string>[] mResponseHeaders = null;
        public ConnectionInfo(Exception exception, int timeout, int size, DateTime startTime, DateTime endTime, KeyValuePair<string, string>[] respHeaders)
        {
